...
loop_stations <- nearest_stations(LAT = centroid@coords[2],
                                  ...
                                  loop_stations <-
                                  GSOD_stations[GSOD_stations$STNID %in% loop_stations,]
...
# create file list
loop_stations <- do.call(paste0, c(expand.grid(loop_stations, "-", years, ".op.gz")))
...
## Examining the Data
Install `visdat`, `devtools::install_github("njtierney/visdat")`
```{r, echo=FALSE, eval=TRUE}
load(file = "IRRI_loop.Rdata") # saves time loading vs downloading in previous step
library(visdat)
```
